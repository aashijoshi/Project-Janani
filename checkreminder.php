...
include('connect.php');
$subject = 'Reminder';
$to = 'sourabh.nainava@ymail.com'; // an email address is required to be given here.
...
{
$Status_message = "There are no reminders set today,Today is : " .date('Y-m-d'); // if there are no active remindes set today.
}
